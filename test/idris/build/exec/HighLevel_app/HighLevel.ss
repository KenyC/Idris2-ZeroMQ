...
(define NetworkC-45ZeroMQ-case--recvMany-3965 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 arg-5) (let ((sc0 arg-5)) (cond ((equal? sc0 0) (PreludeC-45Interfaces-C-60C-36C-62 'erased 'erased 'erased (lambda (eta-0) (lambda (eta-1) (lambda (eta-2) (lambda (eta-3) (ControlC-45MonadC-45Either-map_Functor_C-40C-40EitherTC-32C-36eC-41C-32C-36mC-41 'erased 'erased 'erased 'erased (let ((sc1 (let ((sc2 (let ((sc3 arg-1)) (let ((e-1 (vector-ref sc3 1))) e-1)))) (let ((e-1 (vector-ref sc2 1))) e-1)))) (let ((e-1 (vector-ref sc1 1))) e-1)) eta-2 eta-3))))) (lambda (arg-6) (vector 1 arg-4 arg-6)) (NetworkC-45ZeroMQ-recvMany 'erased arg-1 arg-3 arg-2))) (else (ControlC-45MonadC-45Either-pure_Applicative_C-40C-40EitherTC-32C-36eC-41C-32C-36mC-41 'erased 'erased 'erased (let ((sc1 (let ((sc2 arg-1)) (let ((e-1 (vector-ref sc2 1))) e-1)))) (let ((e-1 (vector-ref sc1 1))) e-1)) (vector 1 arg-4 (vector 0 ))))))))
(define NetworkC-45ZeroMQ-case--recv-3789 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 arg-5 arg-6) (let ((sc0 arg-6)) (case (vector-ref sc0 0) ((1) (let ((e-1 (vector-ref sc0 1))) (let ((sc1 (let ((sc2 arg-1)) (let ((e-3 (vector-ref sc2 1))) e-3)))) (let ((e-2 (vector-ref sc1 2))) ((((e-2 'erased) 'erased) (let ((sc2 arg-1)) (let ((e-5 (vector-ref sc2 2))) ((e-5 'erased) (lambda (eta-0) (NetworkC-45ZeroMQC-45Internal-prim__idris_free_recv_struct arg-4 eta-0)))))) (lambda (_-3814) (let ((sc2 (let ((sc3 (let ((sc4 arg-1)) (let ((e-6 (vector-ref sc4 1))) e-6)))) (let ((e-7 (vector-ref sc3 1))) e-7)))) (let ((e-6 (vector-ref sc2 2))) ((e-6 'erased) (vector 0 e-1)))))))))) (else (let ((sc1 (let ((sc2 arg-1)) (let ((e-1 (vector-ref sc2 1))) e-1)))) (let ((e-2 (vector-ref sc1 2))) ((((e-2 'erased) 'erased) (let ((sc2 arg-1)) (let ((e-4 (vector-ref sc2 2))) ((e-4 'erased) (lambda (eta-0) (NetworkC-45ZeroMQC-45Internal-prim__idris_get_payload arg-4 eta-0)))))) (lambda (payload) (let ((sc2 (let ((sc3 arg-1)) (let ((e-5 (vector-ref sc3 1))) e-5)))) (let ((e-5 (vector-ref sc2 2))) ((((e-5 'erased) 'erased) (let ((sc3 arg-1)) (let ((e-7 (vector-ref sc3 2))) ((e-7 'erased) (lambda (eta-0) (NetworkC-45ZeroMQC-45Internal-prim__idris_free_recv_struct arg-4 eta-0)))))) (lambda (_-3863) (let ((sc3 (let ((sc4 (let ((sc5 arg-1)) (let ((e-8 (vector-ref sc5 1))) e-8)))) (let ((e-9 (vector-ref sc4 1))) e-9)))) (let ((e-8 (vector-ref sc3 2))) ((e-8 'erased) (vector 1 payload)))))))))))))))))
(define NetworkC-45ZeroMQ-case--caseC-32blockC-32inC-32send-3698 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 arg-5 arg-6) (let ((sc0 arg-6)) (case (vector-ref sc0 0) ((1) (let ((e-1 (vector-ref sc0 1))) (let ((sc1 (let ((sc2 (let ((sc3 arg-1)) (let ((e-3 (vector-ref sc3 1))) e-3)))) (let ((e-4 (vector-ref sc2 1))) e-4)))) (let ((e-2 (vector-ref sc1 2))) ((e-2 'erased) (vector 0 e-1)))))) (else (let ((sc1 (let ((sc2 (let ((sc3 arg-1)) (let ((e-1 (vector-ref sc3 1))) e-1)))) (let ((e-1 (vector-ref sc2 1))) e-1)))) (let ((e-2 (vector-ref sc1 2))) ((e-2 'erased) (vector 1 (vector 0 ))))))))))
(define NetworkC-45ZeroMQ-case--send-3654 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 arg-5 arg-6) (let ((sc0 arg-6)) (cond ((equal? sc0 0) (let ((sc1 (let ((sc2 (let ((sc3 arg-1)) (let ((e-1 (vector-ref sc3 1))) e-1)))) (let ((e-1 (vector-ref sc2 1))) e-1)))) (let ((e-2 (vector-ref sc1 2))) ((e-2 'erased) (vector 1 (vector 0 )))))) (else (NetworkC-45ZeroMQ-case--caseC-32blockC-32inC-32send-3698 'erased arg-1 arg-2 arg-3 arg-4 arg-5 (NetworkC-45ZeroMQC-45Data-fromCode_FromCode_ZMQError arg-5)))))))
