...
(define NetworkC-45ZeroMQC-45Internal-prim__idris_zmq_bind (lambda (farg-0 farg-1 farg-2 farg-3 farg-4) ((foreign-procedure #f "idris_zmq_bind" (void* string string int) int) farg-0 farg-1 farg-2 farg-3)))
...
(define NetworkC-45ZeroMQ-bind (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 arg-5) (let ((sc0 (let ((sc1 arg-1)) (let ((e-1 (vector-ref sc1 1))) e-1)))) (let ((e-2 (vector-ref sc0 2))) ((((e-2 'erased) 'erased) (let ((sc1 arg-1)) (let ((e-4 (vector-ref sc1 2))) ((e-4 'erased) (lambda (eta-0) (NetworkC-45ZeroMQC-45Internal-prim__idris_zmq_bind arg-2 (NetworkC-45ZeroMQC-45Data-show_Show_Protocol arg-3) (NetworkC-45SocketC-45Data-show_Show_SocketAddress arg-4) arg-5 eta-0)))))) (lambda (return_code) (let ((sc1 (let ((sc2 (let ((sc3 arg-1)) (let ((e-5 (vector-ref sc3 1))) e-5)))) (let ((e-6 (vector-ref sc2 1))) e-6)))) (let ((e-5 (vector-ref sc1 2))) ((e-5 'erased) (PreludeC-45EqOrd-C-61C-61_Eq_Int return_code 0))))))))))
