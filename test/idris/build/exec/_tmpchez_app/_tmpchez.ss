...
(define NetworkC-45ZeroMQC-45Data-toCode_ToCode_Flags (lambda (ext-0) ext-0))
...
(define NetworkC-45ZeroMQC-45Data-__Impl_ToCode_NetworkC-46ZeroMQC-46DataC-46SocketType (lambda (ext-0) (NetworkC-45ZeroMQC-45Data-toCode_ToCode_NetworkC-46ZeroMQC-46DataC-46SocketType ext-0)))
(define NetworkC-45ZeroMQC-45Data-__Impl_ToCode_Flags (lambda (ext-0) (NetworkC-45ZeroMQC-45Data-toCode_ToCode_Flags ext-0)))
(define NetworkC-45ZeroMQ-case--recv-3387 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 arg-5 arg-6) (let ((sc0 arg-6)) (case (vector-ref sc0 0) ((1) (let ((e-1 (vector-ref sc0 1))) (let ((sc1 (let ((sc2 arg-1)) (let ((e-3 (vector-ref sc2 1))) e-3)))) (let ((e-2 (vector-ref sc1 2))) ((((e-2 'erased) 'erased) (let ((sc2 arg-1)) (let ((e-5 (vector-ref sc2 2))) ((e-5 'erased) (lambda (eta-0) (NetworkC-45ZeroMQC-45Internal-prim__idris_free_recv_struct arg-4 eta-0)))))) (lambda (_-3412) (let ((sc2 (let ((sc3 (let ((sc4 arg-1)) (let ((e-6 (vector-ref sc4 1))) e-6)))) (let ((e-7 (vector-ref sc3 1))) e-7)))) (let ((e-6 (vector-ref sc2 2))) ((e-6 'erased) (vector 0 e-1)))))))))) (else (let ((sc1 (let ((sc2 arg-1)) (let ((e-1 (vector-ref sc2 1))) e-1)))) (let ((e-2 (vector-ref sc1 2))) ((((e-2 'erased) 'erased) (let ((sc2 arg-1)) (let ((e-4 (vector-ref sc2 2))) ((e-4 'erased) (lambda (eta-0) (NetworkC-45ZeroMQC-45Internal-prim__idris_get_payload arg-4 eta-0)))))) (lambda (payload) (let ((sc2 (let ((sc3 arg-1)) (let ((e-5 (vector-ref sc3 1))) e-5)))) (let ((e-5 (vector-ref sc2 2))) ((((e-5 'erased) 'erased) (let ((sc3 arg-1)) (let ((e-7 (vector-ref sc3 2))) ((e-7 'erased) (lambda (eta-0) (NetworkC-45ZeroMQC-45Internal-prim__idris_free_recv_struct arg-4 eta-0)))))) (lambda (_-3461) (let ((sc3 (let ((sc4 (let ((sc5 arg-1)) (let ((e-8 (vector-ref sc5 1))) e-8)))) (let ((e-9 (vector-ref sc4 1))) e-9)))) (let ((e-8 (vector-ref sc3 2))) ((e-8 'erased) (vector 1 payload)))))))))))))))))
(define NetworkC-45ZeroMQ-case--caseC-32blockC-32inC-32send-3296 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 arg-5 arg-6) (let ((sc0 arg-6)) (case (vector-ref sc0 0) ((1) (let ((e-1 (vector-ref sc0 1))) (let ((sc1 (let ((sc2 (let ((sc3 arg-1)) (let ((e-3 (vector-ref sc3 1))) e-3)))) (let ((e-4 (vector-ref sc2 1))) e-4)))) (let ((e-2 (vector-ref sc1 2))) ((e-2 'erased) (vector 0 e-1)))))) (else (let ((sc1 (let ((sc2 (let ((sc3 arg-1)) (let ((e-1 (vector-ref sc3 1))) e-1)))) (let ((e-1 (vector-ref sc2 1))) e-1)))) (let ((e-2 (vector-ref sc1 2))) ((e-2 'erased) (vector 1 (vector 0 ))))))))))
(define NetworkC-45ZeroMQ-case--send-3252 (lambda (arg-0 arg-1 arg-2 arg-3 arg-4 arg-5 arg-6) (let ((sc0 arg-6)) (cond ((equal? sc0 0) (let ((sc1 (let ((sc2 (let ((sc3 arg-1)) (let ((e-1 (vector-ref sc3 1))) e-1)))) (let ((e-1 (vector-ref sc2 1))) e-1)))) (let ((e-2 (vector-ref sc1 2))) ((e-2 'erased) (vector 1 (vector 0 )))))) (else (NetworkC-45ZeroMQ-case--caseC-32blockC-32inC-32send-3296 'erased arg-1 arg-2 arg-3 arg-4 arg-5 (NetworkC-45ZeroMQC-45Data-fromCode_FromCode_ZMQError arg-5)))))))
(define NetworkC-45ZeroMQ-withContext (lambda (arg-0 arg-1 arg-2 arg-3) (let ((sc0 (let ((sc1 arg-2)) (let ((e-1 (vector-ref sc1 1))) e-1)))) (let ((e-2 (vector-ref sc0 2))) ((((e-2 'erased) 'erased) (let ((sc1 arg-2)) (let ((e-4 (vector-ref sc1 2))) ((e-4 'erased) (lambda (eta-0) (NetworkC-45ZeroMQC-45Internal-prim__idris_zmq_ctx_new eta-0)))))) (lambda (context_) (let ((context context_)) (let ((sc1 (let ((sc2 arg-2)) (let ((e-5 (vector-ref sc2 1))) e-5)))) (let ((e-5 (vector-ref sc1 2))) ((((e-5 'erased) 'erased) (arg-3 context)) (lambda (result) (let ((sc2 (let ((sc3 arg-2)) (let ((e-8 (vector-ref sc3 1))) e-8)))) (let ((e-8 (vector-ref sc2 2))) ((((e-8 'erased) 'erased) (let ((sc3 arg-2)) (let ((e-10 (vector-ref sc3 2))) ((e-10 'erased) (lambda (eta-0) (NetworkC-45ZeroMQC-45Internal-prim__idris_zmq_ctx_destroy context eta-0)))))) (lambda (_-3069) (let ((sc3 (let ((sc4 (let ((sc5 arg-2)) (let ((e-11 (vector-ref sc5 1))) e-11)))) (let ((e-12 (vector-ref sc4 1))) e-12)))) (let ((e-11 (vector-ref sc3 2))) ((e-11 'erased) result))))))))))))))))))
